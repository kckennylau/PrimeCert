...
/-! One residue class of the mod-2310 wheel, filtered by the cached sieve bit. The class
`n ≡ 1 mod 2310` has sieve index `t = 770 * k`. -/
...
theorem bench :
    forallB (fun t ↦ (testBitK sieveBits_1000000 t).not'.or'
      ((wieferichB (numK t)).not'.or' (mirimanoffB (numK t)).not')) 0 260 770 := by
  quickRfl
